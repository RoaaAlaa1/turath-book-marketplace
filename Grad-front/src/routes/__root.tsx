...
import { TurathProvider } from "@/lib/turath/store";
import { Layout } from "@/components/turath/Layout";
  ...
  head: () => ({
    meta: [
      ...
      { title: "Turath — Pre-loved & Recycled Books" },
      {
        name: "description",
        content:
          "Turath is a marketplace for pre-loved, recycled and rare books. Give books a new life.",
      },
    ...
    links: [
      ...
      { rel: "icon", type: "image/x-icon", href: "/love-book.ico" },
      { rel: "shortcut icon", href: "/love-book.ico" },
    ],
  }),
