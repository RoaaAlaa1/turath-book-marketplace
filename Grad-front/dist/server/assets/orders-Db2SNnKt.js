import { c as egp, d as apiFetch, f as currentUserId, r as Badge, t as BranchDivider, u as useTurath } from "./Ornaments-DpRPolS7.js";
...
function Orders() {
	...
	useEffect(() => {
		if (!userId) return;
		apiFetch(`/api/Orders/${userId}`).then((data) => {
