import { r as Badge, t as BranchDivider, u as useTurath } from "./Ornaments-CoU_issj.js";
...
function Account() {
	...
	const handleSellerRequest = async () => {
		...
		try {
			...
			if (!response.ok) throw new Error(data?.message || "Unable to submit seller request.");
