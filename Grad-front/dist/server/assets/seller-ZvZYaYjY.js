import { i as Button, p as useTurath, r as Badge, t as BranchDivider, u as egp } from "./Ornaments-JhP4ydzQ.js";
...
function SellerPortal() {
	...
	const isApprovedSeller = role === "seller" || activeUser?.role === "seller" || activeUser?.sellerState === "approved";
	...
	const myBooks = useMemo(() => sellerId ? books.filter((b) => b.sellerId === sellerId && !b.removed && b.approvalStatus !== "Rejected") : [], [books, sellerId]);
	const myOrders = useMemo(() => sellerId ? orders.filter((o) => o.lines.some((l) => l.sellerId === sellerId)) : [], [orders, sellerId]);
	const revenue = myOrders.filter((o) => o.status !== "Cancelled").reduce((s, o) => s + o.lines.filter((l) => l.sellerId === sellerId).reduce((n, l) => n + l.price * l.quantity, 0), 0);
	if (isPendingSeller) return /* @__PURE__ */ jsx("div", {
	...
	if (!isApprovedSeller) return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("p", {
					className: "text-sm leading-relaxed text-muted-foreground",
					children: "Share your literary treasures with readers across Turath. Submit a seller application to start listing books, managing your inventory, and fulfilling orders."
				}),
				/* @__PURE__ */ jsx("div", {
					className: "mt-6 flex flex-wrap items-center justify-center gap-3",
					children: activeUser ? /* @__PURE__ */ jsx(Button, {
						onClick: () => {
							window.location.href = "/account";
						},
						children: "Go to Account & Apply"
					}) : /* @__PURE__ */ jsx(Button, {
	...
	const handleSuggestCategory = async () => {
		...
		if (await requestCategory(newCategoryName.trim())) {
			toast.success(`Category request for "${newCategoryName.trim()}" submitted for admin approval.`);
			setNewCategoryName("");
			setCategoryModalOpen(false);
		} else toast.error("Failed to submit category request.");
	};
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("h2", {
							...
							children: [/* @__PURE__ */ jsx(Button, {
								...
								children: "Suggest Category"
							}), /* @__PURE__ */ jsxs(Button, {
								size: "sm",
								onClick: () => setEditing(blankBook(sellerId, categories[0] ?? "Fiction")),
					...
					/* @__PURE__ */ jsx(Dialog, {
						...
						children: /* @__PURE__ */ jsxs(DialogContent, {
							...
							children: [
								/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: "Suggest a New Category" }) }),
								/* @__PURE__ */ jsxs("div", {
									className: "space-y-3 py-3",
									children: [/* @__PURE__ */ jsx("p", {
										className: "text-sm text-muted-foreground",
										children: "Request a new genre or subject category. It will become available once approved by the administrator."
									}), /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(BookCover, {
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("p", {
											...
											children: b.title
										}), b.approvalStatus === "Pending" ? /* @__PURE__ */ jsx(Badge, {
											variant: "outline",
											className: "bg-amber-100/60 text-amber-900 border-amber-300 text-[10px]",
											children: "Pending Review"
										}) : b.approvalStatus === "Approved" ? /* @__PURE__ */ jsx(Badge, {
											variant: "outline",
											className: "bg-emerald-100/60 text-emerald-900 border-emerald-300 text-[10px]",
											children: "Live"
										}) : null]
									}),
									/* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsx("h2", {
					...
					children: /* @__PURE__ */ jsxs(Table, { children: [/* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsxs(TableRow, { children: [
						...
						/* @__PURE__ */ jsx(TableCell, {
							className: "text-sm text-muted-foreground",
							children: o.lines.filter((l) => Boolean(activeUser?.id && l.sellerId === activeUser.id)).map((l) => `${l.title} ×${l.quantity}`).join(", ")
						}),
						/* @__PURE__ */ jsx(TableCell, {
							className: "text-sm",
							children: o.placedAt
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx(Label, {
									htmlFor: "bf-image",
									children: "Book Cover Image (URL or Upload)"
								}),
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(Input, {
										...
										className: "cursor-pointer inline-flex items-center justify-center rounded-md border bg-muted px-3 text-xs font-medium hover:bg-accent whitespace-nowrap",
										children: ["Upload File", /* @__PURE__ */ jsx("input", {
											type: "file",
											accept: "image/*",
											className: "hidden",
											onChange: (e) => {
								...
								draft.imageUrl && /* @__PURE__ */ jsxs("div", {
									className: "mt-2 flex items-center gap-3 rounded border p-2 bg-muted/40",
									children: [/* @__PURE__ */ jsx("img", {
										...
										className: "text-xs text-muted-foreground",
										children: "Image preview attached"
									})]
								})
							]
						}),
