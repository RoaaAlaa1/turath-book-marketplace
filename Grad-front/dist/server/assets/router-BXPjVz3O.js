import { a as cn, d as useTurath, i as Button, l as egp, o as TAX_RATE, r as Badge, s as TurathProvider, t as BranchDivider, u as roleLabels } from "./Ornaments-BXcZZqjl.js";
import { t as turath_emblem_default } from "./turath-emblem-CeSt8fKn.js";
import { n as Input, t as Label } from "./label-DpRl4tTI.js";
import { t as Separator } from "./separator-hjhegIn5.js";
...
import { t as Route$6 } from "./orders-DfeJMo2Q.js";
...
var styles_default = "/assets/styles-DF8NM3H9.css";
//#endregion
...
function AuthSheet({ open, onOpenChange }) {
	...
	const submitSignIn = async () => {
		...
		try {
			...
			if (data?.token) localStorage.setItem("token", data.token);
			const localUserName = data?.firstName && data?.lastName ? `${data.firstName} ${data.lastName}`.trim() : data?.username || email.trim().split("@")[0] || "Turath User";
			if (!signIn(email)) registerUser({
				name: localUserName,
				email: email.trim(),
				phone: data?.phoneNumber || void 0,
				role: "customer"
			});
...
var $$splitComponentImporter$4 = () => import("./routes-D1deUzds.js");
...
var $$splitComponentImporter$3 = () => import("./account-BNWyTpxD.js");
...
var $$splitComponentImporter$2 = () => import("./admin-DY8WM1ns.js");
...
var $$splitComponentImporter$1 = () => import("./seller-DfaNpMRs.js");
...
var $$splitComponentImporter = () => import("./shop-w5GIGVku.js");
