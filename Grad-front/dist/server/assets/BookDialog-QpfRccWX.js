import { d as resolveUserName, i as Button, l as avgRating, p as useTurath, r as Badge, u as egp } from "./Ornaments-JhP4ydzQ.js";
...
import { Heart, Pencil, ShoppingBasket, Star } from "lucide-react";
...
function BookDialog({ book, onOpenChange }) {
	const { addToCart, toggleWishlist, wishlist, sellerName, addReview, editReview, activeUser, orders, role, users } = useTurath();
	...
	if (!book) return null;
	const wished = wishlist.includes(book.id);
	const purchased = orders.some((o) => activeUser?.id && o.customerId === activeUser.id && o.lines.some((l) => l.bookId === book.id));
	const canReview = (role === "customer" || role === "seller") && (purchased || Boolean(activeUser));
	const submitReview = () => {
		if (comment.trim().length < 4) return;
		addReview(book.id, {
			author: activeUser?.name ?? "Reader",
			rating,
			...
			children: [
								...
								children: [
									...
									/* @__PURE__ */ jsxs("span", {
										...
										children: [
											/* @__PURE__ */ jsx(Leaf$1, {}),
											" ",
											sellerName(book.sellerId, book.sellerName)
										]
									})
								]
							}),
				...
				/* @__PURE__ */ jsxs("section", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("ul", {
							className: "space-y-3",
							children: book.reviews.map((r) => {
								const isMyReview = Boolean(activeUser) && (r.author === activeUser?.name || r.author === activeUser?.email || r.author === activeUser?.id || role === "admin");
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [
												/* @__PURE__ */ jsx("span", {
													...
													children: resolveUserName(r.author, users)
												}),
												...
												isMyReview && /* @__PURE__ */ jsxs("button", {
													type: "button",
													onClick: () => {
														setEditingReview(r);
												...
												/* @__PURE__ */ jsx("span", {
													className: isMyReview ? "text-xs text-muted-foreground" : "ml-auto text-xs text-muted-foreground",
													children: r.date
												})
											]
										}),
						...
						/* @__PURE__ */ jsx(Dialog, {
							...
							children: /* @__PURE__ */ jsxs(DialogContent, {
								...
								children: [
									/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: "Edit Your Review" }) }),
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("div", {
											...
											children: [
												...
												children: /* @__PURE__ */ jsx(Star, { className: `h-5 w-5 ${n <= editRating ? "fill-amber-gold text-amber-gold" : "text-muted-foreground"}` })
											}, n))
									...
									/* @__PURE__ */ jsxs(DialogFooter, { children: [/* @__PURE__ */ jsx(Button, {
										...
										disabled: editComment.trim().length < 4,
